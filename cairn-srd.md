...
多数物品占用一个栏位，小件物品可打包合并。栏位是抽象的，监守可酌情重新安排。
...
关于护甲、伤害和栏位数值，见**装备列表**。小件物品有时可打包进一个栏位中。
...
### 匮乏&疲劳
**匮乏**关键需求（譬如食物或休息）的 PC 无法恢复 HP 或属性值。任何匮乏一天以上的人物都会在其行装中添加**疲劳**，每天一次。每项疲劳占用一个栏位，持续到其能够复原（譬如在安全地点休息一整夜）。PC 还会从**施法**或叙事事件中遭受疲劳。
...
## 魔法
**法术书**包含一道魔法，占用一个栏位。它们无法被誊写或创造；而要从墓穴、地城和庄园等地方发掘出来。
...
**行装**  
PC 有 10 个行装栏位：4 个在身上，6 个在背包（背包清空后可充当睡袋）。多数物品占用一个栏位，但小件物品可打包。**笨重**物品占用两个栏位，并且不便或难以携带。

填满十个物品栏位会使 PC 降至 0 HP。PC 无法携带超出其行装准许数量，不过板车&马可提供额外栏位。

**匮乏**  
**匮乏** PC 无法恢复 HP。若匮乏时间超过一天，会在其行装中增加一项**疲劳**。疲劳占用一个栏位，并持续到能够安全恢复。此效果可累计。

**治疗**  
休息片刻并喝口水可以恢复损失的 HP，但会让冒险团队脆弱。**能力**损失需要休息一周和熟练治疗师的援助。

**法术书**  
法术书包含一道魔法，占用一个物品栏位。任何人都能通过双手持握法术书高声诵读其中内容来施法。施法会往 PC 的行装中增加**疲劳**。
