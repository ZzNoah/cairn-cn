...
### 共同目标
玩家应相互信任，沉浸到共享设定、角色目标和团队挑战当中。因此，冒险团队通常是作为一超群伍，为实现共同目标而协同努力。
 ...
 *碧不慎闯入了一只庞大森巨魔的地盘。她必须通过一次敏捷豁免才能在巨魔之前行动。她失败了，所以巨魔率先攻击。*
</details>
 ...
 *森巨魔咆哮着挥舞棍棒砸向拥有 5 HP 的碧。棍棒造成 1d10 伤害，监守投骰出 4。伤害因碧的皮甲而减去 1，使碧的剩余 HP 为 2。*
</details>
...
### 超群
大群同类参战者并肩作战时会视为单个**超群**。当超群遭受危急伤害时，就会被击溃或大大削弱。当其力量降至 0 时就会遭到摧毁。

个体对超群的攻击会**削弱**（群攻伤害除外）。  
超群对个体的攻击会**增强**并造成群攻伤害。
